<?php
$fieldData = array(
		array("ICU",$start,"-",round(100),round(500),round(200)),
		array("ICU",$start,"-",round(100,1000),round(500,7000),round(200,3000)),
		array("ICU",$start,"-",round(100,1000),round(500,7000),round(200,3000)),
		array("Room 6",$start,"-",round(100,1000),round(500,7000),round(200,3000)),
		array("Room 6",$start,"-",round(100,1000),round(500,7000),round(200,3000)),
		array("Room 8",$start,"-",round(100,1000),round(500,7000),round(200,3000)),
		array("Room 8",$start,"-",round(100,1000),round(500,7000),round(200,3000)),
		array("Room 8",$start,"-",round(100,1000),round(500,7000),round(200,3000)),
);
