...
<div class="col-lg-12">
	<div class="post-body">
		<?php if ($kas_data) {
			foreach ($kas_data as $row) { $tgl_trx=$row->tgl_catat;?>
				...
				<div class="col-lg-12">
					<div class="card">
					  <div class="panel-heading"><?= $this->lang->line('bukti_kas_keluar') ?>
   <span class="pull-right">
   <?php if($row->posting=='1') { echo $this->lang->line('posted') ?>  <a href="<?php echo site_url()."kas/unpost_data_kas_out/".$id_trx; ?>" style="color:#fff;" class="btn btn-danger btn-xs">EDIT DATA / UNPOST</a> <?php } else { ?>
   <?php } ?>
  </span>
  </div>
  <hr/>
						  ...
						  <td><input type="text" name="tanggal" id="datepicker" size="30" maxlength="30" class="form-control" value="<?php echo $tgl_trx; ?>" required /></td>
								...
								<tr>
									...
									<td  style="vertical-align: top;">Dibayarkan kepada</td>
          							<td  style="vertical-align: top;" colspan="3"><input type="text" class="form-control" name="dari" id="dari" value="<?php echo $row->kepada; ?>" <?php echo $disabled; ?> />
									</td>
								</tr>
								<tr>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Rincian Pembayaran</h5>
