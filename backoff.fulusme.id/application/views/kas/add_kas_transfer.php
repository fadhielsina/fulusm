...
<br/>
<div class="post-body">
	<?php 	echo form_open('jurnal/insert_kas_transfer', array('id' => 'jurnal_form','class' => 'form-material m-t-40'));
	...
	echo "</div>"; ?>	
		<div class="card">
  <div class="card-body">
  <h4 class="card-title"><?= $this->lang->line('transfer_kas') ?></h4>
	<div class="col-lg-12">	
	 <div class="panel panel-info">
  <div class="panel-body">
	<table class="table no-border color-table info-table">
	<input type="hidden" class="form-control" name="jns" id="jns" value="TK"  />
		...
		<tr>
          <td  style="vertical-align: top;"><?= $this->lang->line('dari_kas') ?></td>
          <td  style="vertical-align: top;" >
          	<?php
				echo form_dropdown('akun_dari', $accounts, '' , array(
		 ...
		 <tr>
          <td  style="vertical-align: top;"><?= $this->lang->line('untuk_kas') ?></td>
          <td  style="vertical-align: top;" >
          	<?php
				echo form_dropdown('akun_untuk', $accounts, '' , array(
					'class' => 'form-control form-control-line'
				));
			?>
		  </td>
        ...
        <tr>
          <td  style="vertical-align: top;">No Dokumen</td>
          <td  style="vertical-align: top;" ><input type="text"  name="no_dok" class="form-control form-control-line" id="no_dok" />
		  </td>
		</tr>
		<tr>
		<td style="vertical-align: top;"><?= $this->lang->line('catatan') ?></td>
		<td style="vertical-align: top;" >
		<textarea name="catatan" value="2" class="form-control form-control-line" required=""></textarea>
		</td>
		</tr>
		  <tr>
          <td  style="vertical-align: top;"><?= $this->lang->line('jumlah') ?></td>
          <td  style="vertical-align: top;" ><input type="text"  name="jumlah" class="form-control form-control-line" id="jumlah" onkeyup="formatNumber(this);" required="" />
		  </td>
        </tr>
		  <tr>
          <td  style="vertical-align: top;"><?= $this->lang->line('terbilang') ?></td>
          <td  style="vertical-align: top;" ><input type="text" name="terbilang"  class="form-control form-control-line" id="terbilang" readonly />
		  </td>
        </tr>
        <tr>
        	<td></td><td><input type="submit" name="submit" class="btn btn-success"></td>
        </tr>
	</table>	
	</div>
	</div>
