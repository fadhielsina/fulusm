...
<br/>
<div class="post-body">
	<?php 	echo form_open('jurnal/insert_kas_setor_to_bank', array('id' => 'jurnal_form','class' => 'form-material m-t-40'));
		...
		<div class="card-body">
			...
			<table class="table color-table info-table">
				...
				<tr>
		          ...
		          <td style="vertical-align: top;" ><input type="text" name="jumlah" class="form-control form-control-line" id="jumlah" onkeyup="formatNumber(this);" />
				  </td>
		        </tr>
				<tr>
				...
				<tr>
				  ...
				  <td style="vertical-align: top;" colspan="3">
					<?php echo form_dropdown('tf_ke', $accounts, '', 'class="form-control" required' ); ?>
				  </td>
				</tr>
