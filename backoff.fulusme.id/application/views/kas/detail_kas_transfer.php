...
$tgl_trx=$row->tgl_catat;			
  ...
  <div class="panel-body">
	...
	<div class="card">
  <div class="card-body">
  <div class="panel-heading">Bukti Transfer Kas
   <span class="pull-right">
   <?php if($row->posting=='1') { echo $this->lang->line('posted') ?> <a href="<?php echo site_url()."kas/unpost_data_kas_trf/".$id_trx; ?>" style="color:#fff;" class="btn btn-danger btn-xs">EDIT DATA / UNPOST</a> <?php } else { ?>
   <?php } ?>
  </span>
  </div>
  <hr/>
...
<div class="col-lg-12">
	<div class="card">
  <div class="card-body">
  <h4 class="card-title">Rincian Transfer</h4>
...
<tr>
						...
						<td style="vertical-align: top;" colspan="3">
							<select class="form-control col-md-6" name="akun_untuk" required="">
					...
					<tr>
						...
						<td style="vertical-align: top;" colspan="3">
							<select class="form-control col-md-6" name="akun_dari" required="">
								<?php foreach ($all_kas as $row) : ?>
									<option value="<?= $row->id ?>"><?= $row->nama . ' - ' . $row->kode ?></option>
								<?php endforeach; ?>
							</select>
