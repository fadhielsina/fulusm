...
<?php
	...
	$print_header = '<p style="text-align:center;">Katingan</p><p style="text-align:center;">AMOR GROUP</p><h3 style="text-align:center;">BUKU KAS BENDAHARA PENERIMAAN</h3><p style="text-align:center;">'. $periode_text .'</p>';
?>		
	</div>
	<div class="col-lg-12">
