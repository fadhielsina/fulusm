    ...
    <fieldset class="atas"> <table width="100%">
        <tr>
		  ...
		  <table width="100%">
		     <tr>
              ...
              <td width="5">:</td>
              <td><input required type="text" readonly name="noinvoice_gab" id="noinvoice_gab" size="30" maxlength="30" class="form-control" value="<?php echo $row->invoiceID; ?>" /></td>
            </tr>
		   <tr>
            ...
            <tr>
              ...
              <td width="5">:</td>
              <td><input required type="text" name="invoiceIDmanual" id="invoiceIDmanual" size="30" maxlength="30" class="form-control" value="<?php echo $row->invoiceIDmanual; ?>" /></td>
            </tr>
            <tr>
              <td width="30%">Tgl Invoice</td>
              <td width="5">:</td>
              <td><input type="text" name="trxDate" id="datepicker" value="<?php echo $row->trxDate; ?>" size="30" maxlength="30" class="form-control" /></td>
            </tr>
			 <tr>
              <td colspan="3" style="color:#6b4f4f; background-color: #f0f0f0;border-left: 6px solid #ed7ed9;padding: 6px;"><b><i class="fa fa-fw fa-users"></i> DATA CUSTOMER</b></td>
			 
            </tr>
            <tr>
              <td>Costumer</td>
              <td>:</td>
              <td><input required type="text" name="trxFullName" id="trxFullName"  size="30" maxlength="250" class="form-control" value="<?php echo $row->memberFullName; ?>"/></td>
            </tr>
            <tr>
              <td>Costumer Code</td>
              <td>:</td>
              <td>
                ...
                <input value="<?php echo $row->memberCode; ?>" readonly type="text" name="memberCode" id="memberCode" readonly  size="30" maxlength="50" class="form-control"/>
              </td>
            </tr>
            <tr>
              <td>alamat</td>
              <td>:</td>
              <td><input type="text" name="trxAddress" value="<?php echo $row->memberAddress; ?>" id="memberAddress" readonly  size="30" class="form-control" /></td>
            </tr>
            <tr>
              <td>telp</td>
              <td>:</td>
              <td><input type="text" value="<?php echo $row->memberPhone; ?>" name="trxPhone" id="memberPhone"  size="30" maxlength="50" class="form-control"/></td>
            </tr>
			<tr>
          <td valign="top">Note</td>
          <td>:</td>
          <td><textarea  name="note" id="note"  rows="4" cols="50" style="width: 210px; height: 50px" class="form-control"><?php echo $row->note; ?></textarea></td>
        </tr>
			 <tr>
              <td colspan="3" style="color:#6b4f4f; background-color: #f0f0f0;border-left: 6px solid #ed7ed9;padding: 6px;"> <b>DATA KENDARAAN</b></td>
            ...
            <td>Kode/No Plat</td>
            <td>:</td>
            <td><input type="text" name="nopol" id="nopol"  size="30" maxlength="50" class="form-control" value="<?php echo $row->trxcarno; ?>"/></td>
          </tr>      
          <tr>
            <td>Merk Mobil</td>
            <td>:</td>
            <td>
              ...
              <input  type="text" name="merk" id="merk"   size="30" maxlength="50" class="form-control" value="<?php echo $row->car_merk; ?>"/>
            </td>
          </tr>
					    <tr>
            <td>Type Mobil</td>
        ...
        <td valign="top" style="vertical-align: top;" width="33%">
          ...
          <table width="100%">
            ...
            <td>Tahun Mobil</td>
            <td>:</td>
            <td><input type="text" name="year_vech" id="year_vech"   size="30" maxlength="50" class="field" value="<?php echo $row->car_year; ?>"/></td>
          </tr>
          <tr>
            <td>No Chasis</td>
            <td>:</td>
            <td><input type="text" name="chasis_no" id="chasis_no"   size="30" maxlength="50" class="form-control" value="<?php echo $row->chasis_no; ?>"/></td>
          </tr>

          <tr>
            <td>No Engine</td>
            <td>:</td>
            <td><input type="text" name="engine_no" id="engine_no"   size="30" maxlength="50" class="form-control" value="<?php echo $row->engine_no; ?>"/></td>
          </tr>
          ...
          <tr>
            <td>Kilometer</td>
            <td>:</td>
            <td><input type="text" name="kilometer" id="kilometer"   size="30" maxlength="50" class="form-control" value="<?php echo $row->kilometer; ?>"/></td>
          </tr>

               
			 <tr>
              <td colspan="3" style="color:#6b4f4f; background-color: #f0f0f0;border-left: 6px solid #ed7ed9;padding: 6px;"><b>DATA TRANSAKSI</b></td>
			 
            </tr>
          <tr>
            <td width="30%">Tgl Masuk</td>
            <td width="5">:</td>
            <td><input type="text" name="trxInDate" value="<?php echo $row->trxInDate; ?>" id="datepicker2" size="30" maxlength="30" class="form-control"/></td>
          </tr>
          <tr>
            <td width="30%">Tgl Keluar</td>
            <td width="5">:</td>
            <td><input type="text" name="trxOutDate" id="datepicker3" size="30" maxlength="30" class="form-control" value="<?php echo $row->trxOutDate; ?>"/></td>
          </tr>  
		 <tr>
          <td width="30%">Total Instalasi</td>
          <td width="5">:</td>
          <td><input type="text" name="trxInstalasiTotal" id="trxInstalasiTotal"  size="30" maxlength="30" class="form-control" onkeyup="formatNumber(this);" onchange="formatNumber(this);" value="<?php echo number_format($row->trxInstalasiTotal); ?>"/></td>
        </tr>
         <tr>
          <td width="30%">Total Sparepart</td>
          <td width="5">:</td>
          <td><input type="text" name="trxSparepartTotal" id="trxSparepartTotal"  size="30" maxlength="30" class="form-control" onkeyup="formatNumber(this);" onchange="formatNumber(this);" value="<?php echo number_format($row->trxSparepartTotal); ?>"/></td>
        </tr>
        <tr>
          <td width="30%">Total Jasa</td>
          <td width="5">:</td>
          <td><input type="text" name="trxJasaTotal" id="trxJasaTotal"  size="30" maxlength="30" class="form-control" onkeyup="formatNumber(this);" onchange="formatNumber(this);" value="<?php echo number_format($row->trxJasaTotal); ?>"/></td>
        </tr>  
		<tr>
          <td>Discount</td>
          <td>:</td>
          <td><input class="form-control" type="text" name="trxDiscount" id="trxDiscount"  size="30" maxlength="50"  onkeyup="formatNumber(this);" onchange="formatNumber(this);" value="<?php echo number_format($row->trxDiscount); ?>"/></td>
        </tr>
		  <tr>
          <td>Subtotal</td>
          <td>:</td>
          <td><input class="form-control" type="text" name="trxSubtotal" id="trxSubtotal"  size="30" maxlength="50"  onkeyup="formatNumber(this);" onchange="formatNumber(this);" value="<?php echo number_format($row->trxSubtotal); ?>"/></td>
        </tr>
        <tr>
          <td>PPN</td>
          <td>:</td>
        ...
        <tr>
          <td>Faktur Total</td>
          <td>:</td>
          <td><input type="text" name="trxTotal" id="trxTotal"  size="30" maxlength="50" onkeyup="formatNumber(this);" onchange="formatNumber(this);" value="<?php echo number_format($row->trxTotal); ?>"/></td>
        </tr>
      ...
      <td valign="top" style="vertical-align: top;" width="33%">
       <table>
		 ...
		 <tr>
              <td colspan="3" style="color:#6b4f4f; background-color: #f0f0f0;border-left: 6px solid #ed7ed9;padding: 6px;"><b>DATA PEMBAYARAN</b></td>
		 ...
		 <tr>
          ...
          <td  style="vertical-align: top;"><input class="form-control" type="text" name="trxTotalbyr" id="trxTotalbyr"  size="30" maxlength="50"onkeyup="formatNumber(this);" onchange="formatNumber(this);" value="<?php echo number_format($row->trxPay); ?>"/>
		  </td>
        </tr>
		...
		<HR/>
		 ...
		 <tr>
              <td colspan="3" style="color:#6b4f4f; background-color: #f0f0f0;border-left: 6px solid #ed7ed9;padding: 6px;"><b><i>UNTUK PEMBAYARAN NON TUNAI</i></b></td>
		...
		<tr>
          <td style="vertical-align: top;">No Kartu</td>
		   <td  style="vertical-align: top;">:</td>
          <td><input type="text" class="form-control" name="no_kar" id="no_kar"  size="30" maxlength="50"  value="<?php echo $row->trxbanknorek; ?>"/></td>
        </tr>
			<tr >
		<td style="vertical-align: top;">Bank EDC</td>
         ...
         <tr >
          <td style="vertical-align: top;">Biaya Admin</td>
		   <td  style="vertical-align: top;">:</td>
          <td><input class="form-control" type="text" name="b_admin" id="b_admin"  size="30" maxlength="50"  onkeyup="formatNumber(this);" onchange="formatNumber(this);" value="<?php echo number_format($row->trxbankadmin); ?>"/></td>
        </tr>
		 <tr>
  <td colspan="3">
  <input type="submit" value="SIMPAN PERUBAHAN" class="btn btn-info "/>
  <a href="<?php echo site_url('invoice/');?>" class="btn btn-warning "
...
<?php if($is_publish!=1) { ?>
	...
	<table width="300" border="0" align="center" cellpadding="2" cellspacing="0">
		...
		<tr>
			<th><?php echo form_label('No. Jurnal*','nomor'); ?></th>
			<td>
				<?php 
					$datajur['name'] = $datajur['id'] = 'nomor';
					$datajur['title'] = "Nomor tidak boleh kosong";
					$datajur['class'] = "form-control";
					$datajur['value'] =$jurid;
					
					echo form_input($datajur);
				?>
			</td>				
		</tr>
	</table>
