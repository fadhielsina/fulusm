<div class="post-body">
	<?php echo form_open('purchasing/insert_pay_debt'); ?>
	<div class="col-lg-12">
		<div class="card card-outline-info">
			<div class="card-header">
				<h4 class="mb-0 text-white pull-left">Pembayaran Hutang</h4>	
			...
			<div class="card-body">
				<div class="container">
					<div class="row">
						...
						<div class="col">
								<label class="col-lg-12 col-form-label">Akun Kas / Bank Pusat</label><br/>
							<select class="form-control" name="akun_kas_pusat" required="">
							...
							<div class="col">
								<label class="col-lg-12 col-form-label">Akun Kas / Bank Unit</label><br/>
							<select class="form-control" name="akun_kas" required="">
								<?php foreach ($all_kas_unit as $row) : ?>
									<option value="<?= $row->id ?>"><?= $row->nama . ' - ' . $row->kode ?></option>
								<?php endforeach; ?>
							</select>
							</div>
