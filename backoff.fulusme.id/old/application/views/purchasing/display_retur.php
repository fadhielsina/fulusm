                ...
                <div class="col-lg-12">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <?php echo form_open('purchasing/purchasing_retur'); ?>
                            <div class="panel panel-info">
                                <div class="panel-body">
                                    <div class="row">
                                        <!-- <div class="col-4">
                                ...
                                <table class="display" id="table_data_hutang">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 60px">Tgl Cancel</th>
                                            <th>Customer</th>
                                    ...
                                    <tbody>
                                        <?php
                                        if ($journal_data) {
                                            echo anchor(site_url() . "purchasing/debt_payment_all/" . $journal_data[0]->id_project, 'Bayar Otomatis', ['class' => 'btn btn-success', 'onclick' => "return confirm('Are you sure?')"]);
