				...
				<div class="container">
					...
					<div class="row mb-4">
						...
						<div class="col">
							...
							<h5><?= $history_project->jumlah_lot ?></h5>
						</div>
						<div class="col">
				...
				<div class="container">
					...
					<form action="<?= base_url('project/form_project') ?>/<?= $data_project->id_project ?>" method="post">
						...
						<div class="row mb-4">
							...
							<div class="col">
								<label>Jumlah Lembar Saham Yang Diterbitkan</label>
								<h5><input class="form-control" <?= $cek ?> type="text" onkeyup="hitung_lot()" name="jumlah_lot" id="jumlah_lot" value="<?= number_format($data_project->jumlah_lot) ?>"></h5>
							</div>
							<div class="col">
								<label>Harga PerLot Saham</label>
