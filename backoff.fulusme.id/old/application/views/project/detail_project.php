					...
					<div class="col">
						...
						<table class="table">
							<tbody>
								...
								<tr>
									<td class="font-bold">Nama Pengelola Dana</td>
					...
					<div class="col">
						<table class="table">
							...
							<tbody>
								...
								<tr>
									<td class="font-bold ">Prospektus</td>
								...
								<tr>
									<td class="font-bold ">Akad Pengelola Dana</td>
							...
							<table class="table">
								...
								<tbody>
									...
									<tr>
										...
										<td class="pb-0"><a href="<?= base_url('data_peminjam/download_doc') ?>/<?= $data_project->dokumen_pendukung ?>"><i class="mdi mdi-folder-download" title="Download File" style="font-size:23px; color:green;"></i></a></td>
									</tr>
								</tbody>
							</table>
						<?php endif; ?>
