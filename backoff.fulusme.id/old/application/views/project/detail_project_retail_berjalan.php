        ...
        <div class="row">
                ...
                <div class="container mb-3">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <h4><span><?= $dana_terkumpul->nominal / $datproject->harga_perlot ?>/<?= $datproject->jumlah_lot ?></span></h4>
            ...
            <div class="col-lg-6">
                ...
                <div class="container mb-3">
                    ...
                    <form action="<?= base_url('project_retail/market_place') ?>/<?= $project->id  ?>" method="post">

                        <?php $keuntungan = $dana_terkumpul->nominal * ($project->persentasi_keuntungan / 100);

                        $lender = $keuntungan * ($project->lender / 100);

                        $ujrah = $dana_terkumpul->nominal * (1 / 100);

                        $pinjaman_di_tf = $dana_terkumpul->nominal - $ujrah;
                        ?>

                        <ul class="list-group mb-3">
                            <span class="list-group-item d-flex justify-content-between align-items-center">
                                Nama Pengelola Dana
                                <span style="width:160px;"><input type="text" class="form-control text-center" value="<?= $project->nama_peminjam ?>" readonly style="font-size:15px; color:black;" name="virtual_account" id="virtual_account"></span>
                            </span>

                            <span class="list-group-item d-flex justify-content-between align-items-center">
                                Nama Toko
                                <span style="width:160px;"><input type="text" class="form-control text-center" value="<?= $detail_project->nama_toko ?>" readonly style="font-size:15px; color:black;" name="virtual_account" id="virtual_account"></span>
                            </span>
                        </ul>
                        ...
                        <ul class="list-group">
                            ...
                            <span class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <span style="width:160px;"><input type="text" class="form-control text-center" value="<?= number_format($pinjaman_di_tf); ?>" readonly style="font-size:15px; color:black;" name="pinjam_di_tf" id="pinjam_di_tf"></span>
                            ...
                            <span class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <span style="width:160px;"><input type="text" class="form-control text-center" value="<?= number_format($ujrah); ?>" readonly style="font-size:15px; color:black;" name="ujrah" id="ujrah"></span>
                            ...
                            $total = $dana_terkumpul->nominal + $keuntungan;
                ...
                <?php if ($project->status == 1) : ?>
                    ...
                    <?php if ($dana_terkumpul->nominal >= $datproject->modal_project) : ?>
                        ...
                        <?php $status_ijarah = $this->db->get_where('status_project', ['id_project' => $project->id_project])->row()->status_ijarah; ?>
    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body mb-0 p-0">
                ...
                <img src="https://www.fulusme.id/assets/img/profile/<?= $detail_project->foto_toko ?>">
