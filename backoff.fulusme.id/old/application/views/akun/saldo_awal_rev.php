...
<div class="post-title col-lg-12">
	...
	<div class="pull-right">
		...
		echo anchor(site_url('akun/saldo_awal_input_data'),'input saldo awal',array('type' => 'button','class' => 'btn btn-sm waves-effect waves-light btn-rounded btn-warning'));
		?>		
	</div>
</div>
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
      	...
      	<div class="modal-body">
			<div class="form-group">
				<?php echo form_label("Akun Kas/Bank ( Debit )"); ?>
				<?php
					$data['name'] = 'nama'; 
					$data['id'] = 'nama';
					...
					$selected = 'all';
					echo form_dropdown('nama', $all_kas, $selected ,$data); ?>					
			</div>			
			<div class="form-group">
				<?php echo form_label("Akun Kredit"); ?>
				<?php
					$data['name'] = 'kredit'; 
					$data['id'] = 'kredit';
					$data['class'] = "form-control";
					$data['style'] = 'width:100%;';
					$selected = 'all';
					echo form_dropdown('kredit', $akun, $selected ,$data); ?>					
			</div>			
			<div class="form-group"><?php echo form_label("Saldo"); ?>
				<?php 
			...
			<div class="form-group"><?= form_label('per-Tgl'); ?>
