...
<?php
	echo form_open('piutang/'.$form_act, 'id="klien_form"');
...
?>
	...
	<table class="table color-table info-table" cellpadding="2" cellspacing="0">	
		...
		<tr>
			<th><?php echo form_label('Customer ','customer'); ?></th>
			<td>
				<select id="customer" name="customer" class="form-control col-md-6" required>
