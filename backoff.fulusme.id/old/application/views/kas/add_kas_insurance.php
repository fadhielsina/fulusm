  ...
  <h4 class="card-title"><?= $this->lang->line('detail_data') ?></h4>
	...
	<table class="table color-table info-table">
		...
		<tr>
          	...
          	<td  style="vertical-align: top;" ><input type="text" class="form-control" name="jumlah" id="jumlah" onkeyup="formatNumber(this);" />
		  	</td>
        </tr>
		  <tr>
