...
<?php
	...
	$print_header = '<p style="text-align:center;">Katingan</p><p style="text-align:center;">RSUD Mas Amsyar Kasongan</p><h3 style="text-align:center;">BUKU KAS BENDAHARA PENGELUARAN</h3><p style="text-align:center;">'. $periode_text .'</p>';
?>		
	</div>
	<div class="col-lg-12">
		...
		<div class="card">
			...
			<h4 class="card-title"><?php echo 'Report '. $title ?></h4>
				...
				<?php echo form_open('kas/report_kas_keluar'); ?>	
...
<div id="content_area"></div>
  ...
  <div class="card-body">
	...
	<div class="btn-toolbar justify-content-between" role="toolbar" aria-label="Toolbar with button groups">
  	...
  	<h4 class="card-title">
  		<?php echo sprintf( 'Periode: %s s.d %s', $tanggal1 ? $tanggal1 : '-', $tanggal2 ? $tanggal2 : '-'); ?>		
  	</h4>
...
<script type="text/javascript">
	$( function() {
	    ...
	    var headerStack = [ 'Katingan', 'RSUD Mas Amsyar Kasongan', 'BUKU KAS BENDAHARA PENGELUARAN', '<?php echo $periode_text; ?>'],
