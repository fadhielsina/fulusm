...
<div class="col-lg-12">
	...
	<br />
	<div class="post-body">
		<?php echo form_open_multipart('jurnal/insert_kas_masuk', array('id' => 'jurnal_form', 'class' => 'form-material m-t-40'));
			...
			<div class="card-body">
				...
				<table class="table no-border info-table">
					...
					<tr>
					  ...
					  <td  style="vertical-align: top;" colspan="3"><input type="text" class="form-control" name="dari" id="dari" required=""  />
					  </td>
					</tr>
					<tr>
