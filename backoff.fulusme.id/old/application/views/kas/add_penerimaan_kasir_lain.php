...
<br/>
<div class="post-body">
	<?php 	echo form_open('jurnal/insert_jurnal_unpost_penerimaan_lain', array('id' => 'jurnal_form','class' => 'form-material m-t-40'));
	...
	<div class="card">
		<div class="card-body">
			...
			<table class="table color-table info-table">
		        ...
		        <tr>
				  <td style="vertical-align: top;">Dari Akun</td>
				  <td style="vertical-align: top;" colspan="3">
					<?php echo form_dropdown('tf_dari', $accounts, '', 'class="form-control" required' ); ?>
				  </td>
				</tr>
