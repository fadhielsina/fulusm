        ...
        <div class="container-fluid">
         ...
         <div class="row">
            <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#newRoleModal">Tambah Akses Baru</a>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="" data-toggle="modal" data-target="#editMenu" data-role="<?= $r['role'] ?>" data-id="<?= $r['id'] ?>"><span class="badge badge-pill badge-success">Ubah</span></a>
                      <a href="" data-toggle="modal" data-target="#deleteMenu" data-role="<?= $r['role'] ?>" data-id="<?= $r['id'] ?>" ><span class="badge badge-pill badge-danger">Hapus</span></a>
                    </td>
                    <?php $i++; ?>
                  </tr>
                <?php endforeach ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Tambah Akses Baru</h5>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        Apakah Anda akan menghapus Aturan ini? 
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
