        ...
        <div class="container-fluid">
         ...
         <div class="row">
            <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#newMenu">Tambah Submenu</a>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      data-submenu="<?= $sm['menu'] ?>" 
                       ...
                       data-icon="<?= $sm['icon'] ?>"
                       data-is_active="<?= $sm['is_active'] ?>"
                       data-menu="<?= $sm['menu'] ?>" data-id="<?= $sm['id'] ?>" ><span class="badge badge-pill badge-danger">Hapus</span></a>
...
<div class="modal fade" id="editMenu" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Ubah Submenu</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="modal fade" id="deleteMenu" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    height: 60px;
">
        Apakah Anda akan menghapus Submenu ini?
