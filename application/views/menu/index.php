        ...
        <div class="container-fluid">
         ...
         <div class="row">
            <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#newMenu">Tambah Menu Baru</a>
             <table id="tableMenu" class="table table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $m['menu'] ?></td>
                    <td>
                      <a href="" data-toggle="modal" data-target="#editMenu" data-menu="<?= $m['menu'] ?>" data-id="<?= $m['id'] ?>"><span class="badge badge-pill badge-success">Ubah</span></a>
                      <a href="" data-toggle="modal" data-target="#deleteMenu" data-menu="<?= $m['menu'] ?>" data-id="<?= $m['id'] ?>" ><span class="badge badge-pill badge-danger">Hapus</span></a>
                    </td>
                    <?php $i++; ?>
                  </tr>
                <?php endforeach ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        Apakah Anda akan menghapus Menu ini? 
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
