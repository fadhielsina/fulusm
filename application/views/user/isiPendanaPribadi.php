          ...
          <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
            ...
            <form style="margin-top: 30px;" enctype="multipart/form-data" class="user" method="post" action="<?= base_url('user/addPendanaPribadi') ?>">
              ...
              <div class="form-group row">
                <div class="col-lg-6 mb-3 mb-sm-0">
                  <div class="custom-file">
                    <input type="file" class="custom-file-input img-edit" id="image" name="image" required onchange="return fileValidation('image')" for="image" />
              ...
              <div class="form-group row">
                <div class="col-lg-12">
                  <div class="custom-file">
                    <input type="file" class="custom-file-input img-edit" id="slipgaji" name="slipgaji" required onchange="return fileValidation('slipgaji')" for="slipgaji" />
                    <label style="white-space: nowrap;
                        padding-right: 87px;
                        overflow: hidden;
                        text-overflow: ellipsis;
              ...
              <div class="form-group row">
                <div class="col-lg-12">
                  <select name="totalgaji" id="totalgaji" class="custom-select form-control-user-add">
                    <?php if (set_value('totalgaji')) { ?>
                      <option selected value="<?php echo set_value('totalgaji');  ?>"><?php echo set_value('totalgaji');  ?></option>
                    <?php } ?>
                    <option value="">Total gaji dalam setahun</option>
                    <option value="1">
                      < Rp. 500.000.000</option>
                    <option value="2">> Rp. 500.000.000</option>
              ...
              <div class="form-group row">
                <div class="col-lg-6 mb-3 mb-sm-0">
                  <input type="text" class="form-control form-control-user-add" id="custodian" name="custodian" placeholder="Nomor rekening kustodian" value="<?
                                                                                                                                                              ...
                                                                                                                                                              ?>">
                  <small style="color: blue; font-size: 10px;">*isi jika sudah punya</small>
