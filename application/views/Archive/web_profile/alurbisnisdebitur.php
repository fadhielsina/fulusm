...
<!-- Mirrored from dealfintech.com/alurbisnisdebitur.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Mar 2019 10:25:20 GMT -->
<head>
	<meta charset="utf-8">
	...
	<div class="container">
		...
		<!-- Portfolio Images Gallery -->		<div class="row">
			<div class="col-md-12">
				...
				<div class="item-images">
					...
					<a href="#">
						<img src="<?= base_url('assetsprofile/')?>asset/images/proses_pinjam.png" class="img-rounded" />
					</a>
		...
		<!-- Portfolio Description and Other Details -->		<div class="row item-description">
			...
			<div class="col-sm-8">
				...
				<p class="text-justify">Peminjaman :
<p>Jangan biarkan bisnis anda terhenti hanya karena tidak memiliki modal. Daftarkan sekarang juga !!</p>
<p>Kenapa harus meminjam di fulusme?</p>
	<ul>
	<li>Tanpa Agunan/colateral dan dengan persyaratan yang mudah</li>
	<li>Plafon pinjaman hingga mencapai 2 Milyar per pinjaman</li>
	<li>Prosesnya cepat hanya 4 hari</li>
	<li>Berdasarkan hukum syariah dan bagi hasil, sehingga semua jelas di awal dan tidak ada biaya tersembunyi apalagi penalty bagi keterlambatan</li>
</ul>
</p>
