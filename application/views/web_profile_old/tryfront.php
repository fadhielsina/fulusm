        ...
        <div id="carouselExampleControlss" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner" style="color:white">
                <div class="carousel-item active">
                    ...
                    <!--font-weight: 200;-->
                    <!--margin-bottom: 50px;-->
                    <!--">Fulusme adalah Layanan Urun Dana Berbasis Teknologi (Securities Crowd Funding), yang kami bangun untuk dapat bermanfaat bagi dunia bisnis di Indonesia.</p>-->
                    <!--						  </div>-->
                    <!--						</div>-->
                    ...
                    <img src="<?= base_url('assetsprofile/') ?>pic/slide1.jpg" alt="Los Angeles" style="width:120%; height: 80vh;    object-position: revert;
    object-fit: cover;margin-bottom:20px; margin-left:0px; margin-right:-15px; margin-top:0vh;">

                </div>
                <img src="<?= base_url('assetsprofile/') ?>assets/images/170822.jpg" alt="Los Angeles" style="width:100%; height: 80vh;margin-bottom:20px;">
            </div>
            <div class="carousel-item">
        ...
        <h2 class="text-center mt-2">Berizin dan diawasi oleh Otoritas Jasa Keuangan ( OJK )</h2>
        <div style="padding-left: 25%; padding-right: 25%; margin-top: 0; margin-bottom: 0;" class="kt-container ">
            <div class="row">
                <div class="col-lg-4" style="padding:20px;">
                    <a href="#" class="kt-portlet kt-iconbox kt-iconbox--success" style="height:192px;">
                        <div class="kt-portlet__body" style="margin: auto; padding:0;
                                      
											">
                            <div class="kt-iconbox__body">

                                <div class="kt-iconbox__desc kt-iconbox__icon" data-toggle="kt-popover" title="" data-content="wadah tempat bertemunya pemodal dan penerbit yang dihubungkan dengan teknologi aplikasi." style="flex: unset;
													padding-right: unset;">
...
">
                ...
                <div class="col-lg-4" style="padding:20px;">
                    <a href="<?= base_url('welcome/pasarsekunder') ?>" class="kt-portlet kt-iconbox  kt-iconbox--warning" style="border-radius:00px;height:192px;">
                        <div class="kt-portlet__body" style="margin: auto; padding:0;
                                      
											">
                            <div class="kt-iconbox__body">

                                <div class="kt-iconbox__desc kt-iconbox__icon" data-toggle="kt-popover" title="" data-content="Semua prosesnya transparan,terbuka diawal dan menguntungkan semua pihak" style="flex: unset;
													padding-right: unset;">
                                    <svg style="height:100px; width:100%;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
...
">
                ...
                <div class="col-lg-4" style="padding:20px;">
                    <div class="kt-portlet kt-iconbox kt-iconbox--danger" style="height:192px;">
                        <div class="kt-portlet__body" style="margin: auto; padding:0;
                                      
											">
                            <div class="kt-iconbox__body">

                                <div class="kt-iconbox__desc kt-iconbox__icon" data-toggle="kt-popover" title="" data-content="Kami, selalu ada dan siap mendampingi anda 24 jam sehari, 7 kali seminggu dan 365 hari non-stop melalui web kami.
													" style="flex: unset;
													padding-right: unset;">
                                    <svg style="height:100px; width:100%;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
">
        ...
        <div style="background: url(<?= base_url('assetsprofile/') ?>asset/images/latarnew.jpeg); padding-top: 50px; padding-bottom: 40px; height:100%;">
            <h2 class="text-center mb-8" style='color:white; '> Fulusme adalah Layanan Urun Dana berbasis teknologi (securities crowdfunding)
                yang membantu permodalan bagi UKM</h2>
...
">
    ...
    ">
            ...
            <!--ini awal bagian marketplacenya -->
            <div class="kt-container  kt-grid__item kt-grid__item--fluid ">
                ...
                ?>
                    ...
                    <div class="kt-portlet col-lg-32" style="display:inline-block;  
                            ...
                            <div class="kt-widget kt-widget--user-profile-3">
                                <div class="kt-widget__top">
                                    <div class="kt-widget__media kt-hidden-">
                                        ...
                                        <img class="card_holder_img" style="max-width: 100%;
    width: 100%;
    height: 200px;
    object-fit: cover;
    border-radius: 8px;" <?php
                            if ($obj["image"]) {
                            ?> src="<?php echo base_url('assets/') . "img/profile/" . $obj["image"] ?> " <?php
                                                                                                        } else {
    ...
    ">
                                ...
                                <div class="kt-widget__content">
                                    <div class="kt-widget__head">
                                        ...
                                        <a href="#" class="kt-widget__title" style="    color: black;
    font-size: 23px;
    display: inline-block;
    padding: 0px;
    height: 50px;
    margin-bottom: 16px !important;
    margin-top: 16px;"><?php echo $obj["nama_project"] ?></a>



                                        <?php if ($obj["jumlah_pendanaan"] >= 1) { ?>
    ...
    <!--padding: 0px;-->
    <!--margin-bottom: 16px !important;-->
    <!--margin-top: 16px;"><?php echo $obj["jumlah_pendanaan"] ?></a>-->
                                    ...
                                    <div class="kt-widget__info">
                                        <div class="kt-widget__desc">
                                            ...
                                            ?>
                                            <p>Kode Efek : <?php echo $inikodealias ?></p>
                                        ...
                                        ?>
                                            ...
                                            <div class="progress-bar kt-bg-success" role="progressbar" style="width: <?php echo $obj["jumlah_pendanaan"] * 100 ?>%;" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <div class="kt-widget__stats">
                                            <?php echo $obj["jumlah_pendanaan"] * 100 ?>%
                                        </div>
                                    ...
                                    <div class="kt-widget__stats">
                                        <?php echo $obj["totalhari"] - $obj["sisawaktu"] ?> Hari
                                    </div>
                                    ...
                                    <div class="kt-widget__stats d-flex align-items-center flex-fill">
                                        <div class="kt-widget__item">
                                            ...
                                            <div class="kt-widget__label-success">
                                                <span class="btn btn-label-brand btn-sm btn-bold btn-upper" style="display: inline; margin-right:10px;">
                                                    <? if ($obj["prospektus"]) { ?>

                                                        <a href="<?= base_url('assets/file_user/prospektus/
') ?><?= $obj["prospektus"] ?>"> Proposal Bisnis </a>
                                                ...
                                                <?php if ($obj["jumlah_pendanaan"] == 1) { ?>
                                                    <button type="button" style="display: inline;" class="btn btn-brand btn-sm btn-upper" onClick="alert('Project ini sudah terdanai, tunggu project lainnya')">Beli</button>

                                                <?php } else { ?>


                                                    <a href="<?= base_url('auth') ?>">
                                                        <button type="button" style="display: inline;" class="btn btn-brand btn-sm btn-upper">Beli</button></a>
                                                <?php } ?>
                                            </div>
    ...
    font-weight: 400;">Total Pemodalan</span>
    ...
    padding: 0;">
                                    ...
                                    <div class="kt-widget__details">
                                        ...
                                        <span class="kt-widget__title" style="color: #d8d8d8; 
    font-weight: 400;">Jumlah Efek yang diterbitkan</span>
    ...
    padding: 0;">
                                    ...
                                    <div class="kt-widget__details">
                                        ...
                                        <span class="kt-widget__title" style="color: #d8d8d8;
    font-weight: 400;">Harga Per Lembar Efek</span>
    ...
    padding: 0;">
                                    ...
                                    <div class="kt-widget__details">
                                        <span class="kt-widget__title" style="color: #d8d8d8;
    font-weight: 400;">Harga Per 1 Lot Efek</span>
    ...
    padding: 0;">
                                    ...
                                    <div class="kt-widget__details">
                                        <span class="kt-widget__title" style="color: #d8d8d8;
    font-weight: 400;">Jumlah Lot</span>
    ...
    padding: 0;">
                                    ...
                                    <div class="kt-widget__details">
                                        <span class="kt-widget__title" style="color: #d8d8d8;
    font-weight: 400;">Periode Dividen</span>
        ...
        ?>
            <div class="kt-portlet col-lg-3" style="    display: inline-block !important; margin: 15px;">
                <div class="kt-portlet__body">
                    <div class="kt-widget kt-widget--user-profile-3">
                        <div class="kt-widget__top">
...
" alt="image">
    ...
    float: right;
">
                                            <?php echo number_format($obj["nominal"] / $obj["jumlah_pinjaman"] * 100, 1) ?>%
...
">
    ...
    padding: 0;">
                                ...
                                <div class="kt-widget__details">
                                    <span class="kt-widget__title" style="color: #d8d8d8;
    font-weight: 400;">Jumlah Pemodalan</span>
    ...
    padding: 0;">
                                ...
                                <div class="kt-widget__details">
                                    ...
                                    <span class="kt-widget__title" style="color: #d8d8d8;
    font-weight: 400;">Harga Per Efek</span>
    ...
    padding: 0;">
                                ...
                                <div class="kt-widget__details">
                                    ...
                                    <span class="kt-widget__title" style="color: #d8d8d8;
    font-weight: 400;">(fee 5%)</span>
                                    <span class="kt-widget__value"><? echo rupiah($obj["Fee"]) ?></span>
                                </div>
                            </div>
    ...
    font-weight: 400;">Estimasi Net Profit</span>
        ...
        <!--ini akhir bagian marketplacenya -->
...
<div style="width:100%; padding: 50px;background-color: #fff;">

    <section class="features-blocks" style="background-color: #fff;">
        <div class="container">
            <div class="columns is-multiline is-mobile">
                <div class="has-text-centered column is-6-mobile is-2-desktop is-3-tablet">
                    <figure class="box">
                        <img src="<?= base_url('assetsprofile/') ?>assetsbaru/media/logos/ojk-logo.png" class="imgnew">
                ...
                <div class="has-text-centered column is-6-mobile is-2-desktop is-3-tablet">
                    <figure class="box">
                        <img src="<?= base_url('assetsprofile/') ?>assetsbaru/media/logos/kominfo.jpeg" class="imgnew">
                ...
                <div class="has-text-centered column is-6-mobile is-2-desktop is-3-tablet">
                    <figure class="box">
                        <img src="<?= base_url('assetsprofile/') ?>assetsbaru/media/logos/danamon1.png" class="imgnew">
                ...
                <div class="has-text-centered column is-6-mobile is-2-desktop is-3-tablet">
                    <figure class="box">
                        <img src="<?= base_url('assetsprofile/') ?>assetsbaru/media/logos/Pefindo1.png" class="imgnew">
                ...
                <div class="has-text-centered column is-6-mobile is-2-desktop is-3-tablet">
                    <figure class="box">
                        <img src="<?= base_url('assetsprofile/') ?>assetsbaru/media/logos/PSe.jpeg" class="imgnew">
                ...
                <div class="has-text-centered column is-6-mobile is-2-desktop is-3-tablet">
                    <figure class="box">
                        <img src="<?= base_url('assetsprofile/') ?>assetsbaru/media/logos/aludi.jpeg" class="imgnew">
                ...
                <div class="has-text-centered column is-6-mobile is-2-desktop is-3-tablet">
                    <figure class="box">
                        <img src="<?= base_url('assetsprofile/') ?>assetsbaru/media/logos/ksei.jpeg" class="imgnew">
                ...
                <div class="has-text-centered column is-6-mobile is-2-desktop is-3-tablet">
                    <figure class="box">
                        <img src="<?= base_url('assetsprofile/') ?>assetsbaru/media/logos/fintechindo.jpeg" class="imgnew">
                ...
                <div class="has-text-centered column is-6-mobile is-2-desktop is-3-tablet">
                    <figure class="box">
                        <img src="<?= base_url('assetsprofile/') ?>assetsbaru/media/logos/rapidssl.jpeg" class="imgnew">
                ...
                <div class="has-text-centered column is-6-mobile is-2-desktop is-3-tablet">
                    <figure class="box">
                        <img src="<?= base_url('assetsprofile/') ?>assetsbaru/media/logos/googleplaypreview.png" class="imgnew">
                ...
                <div class="has-text-centered column is-6-mobile is-2-desktop is-3-tablet">
                    <figure class="box">
                        <img src="<?= base_url('assetsprofile/') ?>assetsbaru/media/logos/appstorepreview.png" class="imgnew">
