...
<!--												<h2 style="margin-top: 0px; color:white;">Layanan Urun Dana berbasis Teknologi </h2>-->
							...
							<!--font-weight: 200;-->
							<!--margin-bottom: 50px;-->
							<!--">Fulusme Equity adalah Layanan Urun Dana Berbasis Teknologi (Securities Crowd Funding), yang kami bangun untuk dapat bermanfaat bagi dunia bisnis di Indonesia.</p>-->
							<!--						  </div>-->
							<!--						</div>-->
...
<!--							</div>-->
			...
			<a class="carousel-control-next" href="#carouselExampleControlss" role="button" data-slide="next">
				...
				<span class="sr-only">Next</span>
							...
							<h2 class="text-center mt-2">SEDANG DALAM PROSES PERIJINAN OTORITAS JASA KEUANGAN ( OJK ) </h2>
...
">
    ...
    ">
							    ...
							    <div class="kt-container  kt-grid__item kt-grid__item--fluid ">
                                   ...
                                   <div class="kt-portlet col-lg-3" style="display:inline-block;     margin: 15px;">
                                        <div class="kt-portlet__body">
                                                            ...
                                                            <div class="kt-widget__stats d-flex align-items-center flex-fill">
                                                                <div class="kt-widget__item">
                                                                    ...
                                                                    <div class="kt-widget__label-success">
                                                                        <span class="btn btn-label-brand btn-sm btn-bold btn-upper" style="display: inline;">4/5</span>
                                                                        <button type="button" style="display: inline;" class="btn btn-brand btn-sm btn-upper">Danai</button>
                                                                    </div>
    ...
    font-weight: 400;">Jumlah Efek yang diterbitkan</span>
                                                            <span class="kt-widget__value">10.000.000 Lembar Efek</span>
                                                        </div>
                                                    </div>
    ...
    font-weight: 400;">Harga Per 1 Lot Efek</span>
                                                            <span class="kt-widget__value">Rp. 200.000.000</span>(Per 1 Lot 100 Lembar Efek)
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="kt-widget__content">
                                                        <div class="kt-widget__head">
                                                            ...
                                                            <div class="kt-widget__action">
                                                                ...
                                                                <button type="button" class="btn btn-brand btn-sm btn-upper">Danai</button>
       ...
       <div class="container-fluid">
            <div class="row">
                <div class="col-lg-3">
                	...
                	<img src="<?= base_url('assetsprofile/')?>assetsbaru/media/logos/ojk-logo.png" 
                	style="width:150px">		
						
                </div>
                <div class="col-lg-3">
                <img src="<?= base_url('assetsprofile/')?>assetsbaru/media/logos/kominfo.jpeg" 
                	style="width:150px">		
