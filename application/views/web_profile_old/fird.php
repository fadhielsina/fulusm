...
<!-- Mirrored from dealfintech.com/fird.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Mar 2019 10:25:55 GMT -->
...
<body>
	...
	<div class="container">
			<div class="row">
			<div class="col-sm-12">
				<h4>Registrasi Pengelola Dana</h4>
				<li>
	...
	<div class="row justify-content-center">
		...
		<header class="card-header">
			<h4 class="card-title mt-2">Daftar Sebagai Pengelola Dana</h4>
		</header>
		<article class="card-body">
		<form  action="http://dealfintech.com/psrd.php" method="post"> 
			<div class="form-group">
				<label>Jenis Pengelola Dana : </label> 
