...
<div class="container-fluid">
  ...
  <?php if($project): ?>
    ...
    <div class="row" style="background: #f0f2f6; "> 
      <div class="col-lg-3 mb-5 mt-5">
        <div class="card cardDash">
          <div class="card-body">
            <h5 class="card-title">Pinjaman Tertunda</h5>
            Anda Memiliki <?=  sizeof($pending_project) ?>Pinjaman Tertunda <br>
      ...
      <div class="col-lg-3 mb-5 mt-5">
        <div class="card cardDash">
          <div class="card-body">
            ...
            Anda Memiliki <?=  sizeof($ongoing_project) ?> Pinjaman Berjalan <br>
      ...
      <div class="col-lg-3 mb-5 mt-5">
        <div class="card cardDash">
          <div class="card-body">
            <h5 class="card-title">Pinjaman Ditolak</h5>
            Anda Memiliki <?=  sizeof($rejected_project) ?> Pinjaman Ditolak <br>
      ...
      <div class="col-lg-3 mb-5 mt-5">
        <div class="card cardDash">
          <div class="card-body">
            <h5 class="card-title">Pinjaman Berhasil</h5>
            Anda Memiliki <?=  sizeof($finished_project) ?> Pinjaman Berhasil <br>
    ...
    margin-top: -30px;
    margin-bottom: 30px;" href="<?= base_url('project/addproyek') ?>" class="btn btn-success"><i class="far fa-plus-square"></i>     buat proyek baru</a>
