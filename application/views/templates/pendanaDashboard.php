  ...
  <div class="row" style="background: #f0f2f6; "> 
    <div class="col-lg-4 mb-5 mt-5">
      <div class="card cardDash">
        <div class="card-body">
          <h5 class="card-title">Pemodalan Tertunda</h5>
          Anda Memiliki <?=  sizeof($pending_project) ?> Pemodalan Tertunda <br>
    ...
    <div class="col-lg-4 mb-5 mt-5">
      <div class="card cardDash">
        <div class="card-body">
          <h5 class="card-title">Pemodalan Berjalan</h5>
          Anda Memiliki <?=  sizeof($ongoing_project) ?> Pemodalan Berjalan <br>
          <a href="<?= base_url('user/ongoingFunding') ?>"> see detail</a>
        </div>
      </div>
    </div>
...
<script type="text/javascript">
  ...
  "rowCallback": function( row, data ) {
    ...
    li.append('<div class="card-text" style="font-size:12px"> <a class="btn btn-primary justify-content-center d-flex btn-sm" href='+'<?= base_url("user/pendanaProject")?>'+'?id='+data[11]+'> lihat detail</a> </div>')
