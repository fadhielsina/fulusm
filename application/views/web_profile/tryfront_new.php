...
?>
 ...
 <div class="slide-one-item home-slider owl-carousel">
      ...
      <div class="site-blocks-cover inner-page overlay" style="background-image: url(<?php echo base_url(); ?>assetsprofile/assetsbaru/images/hero_bg_2.jpg);" data-aos="fade" data-stellar-background-ratio="0.3">
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-8 text-center" data-aos="fade">
              <h2 class="font-secondary font-weight-bold text-uppercase" style="color:#ff8f3d;">PT. AMSAK BANGUN PERSADA</h2>
              <h3 style="color:#fff;" class="font-secondary font-weight-bold">Proyek Pengadaan Bahan Mineral di Antam</h3>
              <span class="btn btn-success rounded text-white px-4">Yield 18% pa</span>
            </div>
          </div>
        </div>
      </div> 

      <div class="site-blocks-cover inner-page overlay" style="background-image: url(<?php echo base_url(); ?>assetsprofile/assetsbaru/images/hl.jpg);" data-aos="fade" data-stellar-background-ratio="0.3">
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-8 text-center" data-aos="fade">
              <h2 class="font-secondary font-weight-bold text-uppercase" style="color:#ff8f3d;">PT. CAHAYA SOLUSINDO PERKASA</h2>
              <h3 style="color:#fff;" class="font-secondary font-weight-bold">Proyek Pembuatan Hauling Road Construction untuk Jalan Khusus Angkutan Batubara ( Hauling Road ) di Kalimantan Tengah</h3>
              <span class="btn btn-success rounded text-white px-4">Yield 18% pa</span>
            </div>
          </div>
        </div>
    ...
    <div class="row" >
             <div class="col-lg-12">
                ...
                <br/>yang membantu <span style='color:#ff8f3d; '> permodalan bagi UKM</span></h4>
                    </div>
                <br/><br/>
 ...
 <img <?php if ($obj["image"]) {?> src="<?php echo base_url('assets/') . "img/profile/" . $obj["image"] ?> " style="border-bottom:4px #ff6f05 solid;margin-bottom:15px;width:80%;border-radius:0 0 20% 20%; margin-left: auto;
    ...
    <!--margin-top: 16px;"><?php echo $obj["jumlah_pendanaan"] ?></a>-->
	     <p>ID Proyek : <span style=" color: #fd7e14;"><?php echo $obj["id"] ?></span></p>
								 ...
								 <div class="kt-widget__text">
                                        ...
                                        <div class="kt-widget__stats">
                                            <span style=" color: #040538;"><?php echo $obj["jumlah_pendanaan"] * 100 ?>%</span>
                                        </div>
...
') ?><?= $obj["prospektus"] ?>"> <span style=" color: #040538;"> Proposal Bisnis </span></a>
    ...
    padding: 0;">
                                    ...
                                    <div class="kt-widget__details">
                                        ...
                                        <span class="kt-widget__value"><?php echo ($obj["jumlah_lot"]) ?></span>
                                    </div>
                                </div>
   ...
   <div class="site-section">
      <div class="container">
	  <div class="row border-responsive">
                <?php    foreach ($project_retail as $obj) { ?>
...
">
	...
	<div id="collapseOne<?php echo $obj["id"] ?>" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
      <div class="card-body" style="border:none;">
                           ...
                           <div class="kt-widget__details">
                                    <span class="kt-widget__title" >Tenor</span>
    ...
    padding: 0;">
                                    ...
                                    <span class="kt-widget__title" >Harga Per Efek</span>
    ...
    padding: 0;">
                                    ...
                                    <span class="kt-widget__title">(fee 5%)</span>
    ...
    padding: 0;">
                                   ...
                                   <div class="kt-widget__details">
                                    <span class="kt-widget__title">Estimasi Net Profit</span>
   ...
   <!-- end project retail-->
	 ...
	 <div class="site-section" style="background-color:#f7f7f7">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-2 text-center">
            <img src="<?= base_url('assetsprofile/') ?>assetsbaru/media/logos/ojk-logo.png" alt="Image" class="img-fluid" style="width:150px;margin-bottom:15px;">
          </div>
		  ...
		  <div class="col-md-1 text-center">
            <img src="<?= base_url('assetsprofile/') ?>assetsbaru/media/logos/googleplaypreview.png" alt="Image" class="img-fluid" style="width:150px;margin-bottom:15px;">
          </div>
		  <div class="col-md-1 text-center">
            <img src="<?= base_url('assetsprofile/') ?>assetsbaru/media/logos/appstorepreview.png" alt="Image" class="img-fluid" style="width:150px;margin-bottom:15px;">
          </div>
        </div>
      </div>  
    </div>
	...
	<div  class="site-section"  style="background-image: url('<?php echo base_url(); ?>assetsprofile/assetsbaru/images/topography.png'); background-attachment: fixed">
    <div class="container">
