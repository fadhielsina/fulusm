      ...
      <?php foreach ($project as $obj) { ?>
        ...
        <?php if ($obj["totalhari"] - $obj["sisawaktu"] > 0 || $query_pendanaan->jumlah_pendanaan >= 1) : ?>
          ...
          <div class="col-md-6 col-lg-3 mt-5 mb-4 mb-lg-0 border-right" style="font-size:13px;">
            ...
            <!-- <img <?php if ($obj["image"]) { ?> src="<?php echo base_url('assets/') . "img/profile/" . $obj["image"] ?> " style="border-bottom:4px #ff6f05 solid;border-top:4px #ff6f05 solid;margin-bottom:15px;
            width: 90%;height: 250px;border-radius:0 0 10% 10%; margin-left: auto;
